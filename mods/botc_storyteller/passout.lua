...
local DEFAULT_TEAMS = {
    ...
    bounty_hunter = "townsfolk", bountyhunter = "townsfolk", cannibal = "townsfolk", chambermaid = "townsfolk",
    ...
    pixie = "townsfolk", poppy_grower = "townsfolk", poppygrower = "townsfolk", preacher = "townsfolk",
    princess = "townsfolk", professor = "townsfolk", sage = "townsfolk",
    sailor = "townsfolk", savant = "townsfolk", seamstress = "townsfolk",
    shugenja = "townsfolk", snake_charmer = "townsfolk", snakecharmer = "townsfolk", steward = "townsfolk",
    tea_lady = "townsfolk", tealady = "townsfolk", town_crier = "townsfolk", towncrier = "townsfolk", village_idiot = "townsfolk",
    -- Outsiders
    ...
    boomdandy = "minion", cerenovus = "minion", devils_advocate = "minion", devilsadvocate = "minion",
    evil_twin = "minion", eviltwin = "minion", fearmonger = "minion", goblin = "minion",
    godfather = "minion", harpy = "minion", marionette = "minion",
    mastermind = "minion", mezepheles = "minion", organ_grinder = "minion",
    pit_hag = "minion", pithag = "minion", psychopath = "minion", summoner = "minion",
    vizier = "minion", widow = "minion", witch = "minion",
    wizard = "minion", wraith = "minion", xaan = "minion",
    -- Demons
    imp = "demon", al_hadikhia = "demon", fang_gu = "demon", fanggu = "demon",
    kazali = "demon", legion = "demon", leviathan = "demon",
    lil_monsta = "demon", lleech = "demon", lord_of_typhon = "demon",
    no_dashii = "demon", nodashii = "demon", ojo = "demon", po = "demon",
